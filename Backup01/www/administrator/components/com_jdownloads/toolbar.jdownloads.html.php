...
class menujlist {
	...
	function SETTINGS_MENU(){ 
		...
		JToolBarHelper::cancel('',JText::_('JLIST_BACKEND_TOOLBAR_CLOSE'));
	}
	...
	function FILES_LIST(){
        ...
        JToolBarHelper::custom( 'files.upload', 'upload32.png', 'upload32.png', JText::_('JLIST_BACKEND_FILESLIST_TITLE_FILES_UPLOAD'), false, true ); 
        JToolBarHelper::custom( 'manage.files', 'files32.png', 'files32.png', JText::_('JLIST_BACKEND_FILESLIST_TITLE_MANAGE_FILES'), false, false );
    ...
    function FILES_UPLOAD(){
        JToolBarHelper::title( JText::_('JLIST_BACKEND_FILESLIST_TITLE_FILES_UPLOAD'), 'jdlogo' ); 
        JToolBarHelper::custom( 'manage.files', 'files32.png', 'files32.png', JText::_('JLIST_BACKEND_FILESLIST_TITLE_MANAGE_FILES'), false, false );
        JToolBarHelper::custom( 'files.list', 'downloads_2.png', 'downloads_2.png', JText::_('JLIST_BACKEND_CPANEL_FILES'), false, false );
        JToolBarHelper::cancel('',JText::_('JLIST_BACKEND_TOOLBAR_CLOSE'));
    }
    
    function MANAGE_FILES(){
        JToolBarHelper::title( JText::_('JLIST_BACKEND_FILESLIST_TITLE_MANAGE_FILES'), 'jdlogo' ); 
        JToolBarHelper::custom( 'files.upload', 'upload32.png', 'upload32.png', JText::_('JLIST_BACKEND_FILESLIST_TITLE_FILES_UPLOAD'), false, true );
        JToolBarHelper::custom( 'files.list', 'downloads_2.png', 'downloads_2.png', JText::_('JLIST_BACKEND_CPANEL_FILES'), false, false );
        JToolBarHelper::divider();
        JToolBarHelper::deleteList(JText::_('JLIST_BACKEND_FILESLIST_DEL_QUEST_FILES'),'delete.root.files');
    }    
    ...
    function TEMPLATES_LIST_CATS(){
        ...
        JToolBarHelper::custom( 'templates.list.files', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_FILESTITLE_HEAD'), false );
        JToolBarHelper::custom( 'templates.list.details', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_DETAILSTITLE_HEAD'), false );
        JToolBarHelper::custom( 'templates.list.summary', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_SUMTITLE_HEAD'), false );
        JToolBarHelper::divider();
    ...
    function TEMPLATES_LIST_FILES(){
        ...
        JToolBarHelper::custom( 'templates.list.cats', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_CATTITLE_HEAD'), false );
        JToolBarHelper::custom( 'templates.list.details', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_DETAILSTITLE_HEAD'), false );
        JToolBarHelper::custom( 'templates.list.summary', 'template', 'template', JText::_('JLIST_BACKEND_TEMPLIST_SUMTITLE_HEAD'), false );
        JToolBarHelper::divider(); 
    ...
    function LIST_LOGS(){
        JToolBarHelper::title( JText::_('JLIST_BACKEND_CPANEL_DOWNLOAD_LOGS'), 'jdlogo' ); 
        JToolBarHelper::custom( 'add.ip', 'cancel.png', 'cancel.png', JText::_('JLIST_BACKEND_LOG_LIST_BLOCK_IP'), true );
        JToolBarHelper::deleteList(JText::_('JLIST_BACKEND_VIEW_LOGS_DEL_QUEST'),'delete.logs');
    } 
    
    function LIST_GROUPS(){
        JToolBarHelper::title( JText::_('JLIST_BACKEND_CPANEL_GROUPS'), 'jdlogo' ); 
        JToolBarHelper::addNewX('edit.groups');
        JToolBarHelper::deleteList(JText::_('JLIST_BACKEND_VIEW_GROUPS_DEL_QUEST'),'delete.groups');
    } 
    
    function EDIT_GROUPS(){
        JToolBarHelper::title( JText::_('JLIST_BACKEND_GROUPS_EDIT_TITLE'), 'jdlogo' ); 
