...
////////////////////                CATEGORIES              ///////////////////////
function categoriesEdit($option, $row, $inputbox_pic, $access_box, $last_dir_entry, $path_dir_entry, $groups_box){
		...
		if (form.create_auto_cat_dir.value == 1) {
          if (form.cat_title.value == "" || form.catid.value == "" || (form.cat_access.value != 99 && form.cat_group_access.value > 0) || (form.cat_access.value == 99 && form.cat_group_access.value == 0) ){
			if (form.cat_access.value != 99 && form.cat_group_access.value > 0){
                alert( "<?php echo JText::_('JLIST_BACKEND_CATSEDIT_ACCESS_ERROR_TITLE');?>" );
            }  
            if (form.cat_access.value == 99 && form.cat_group_access.value == 0){
                alert( "<?php echo JText::_('JLIST_BACKEND_CATSEDIT_ACCESS_ERROR_TITLE2');?>" );
            }  
		      		...
		      		<td valign="top" align="left" width="100%">
		      			<table>
		  					...
		  					<tr>
		    					...
		    					<td valign ="top"><?php echo " ".JText::_('JLIST_BACKEND_CATSEDIT_CAT_TITLE_DESC'); ?>
                                 ...
                                 if ($jlistConfig['create.auto.cat.dir']){
                                     if (!$row->cat_id){
                                         echo " ".JText::_('JLIST_EDIT_CAT_DIR_TITLE_DESC1'); 
                                     }
                                 }        
                                 ?>
                                </td>
                            ...
                            <tr>
                              ...
                              <tr>
                                <td><strong><?php echo JText::_('JLIST_BACKEND_CATSEDIT_CAT_GROUP_ACCESS_TITLE')." <b><font color=red>*</font></b>"; ?></strong><br />
                                <?php echo $groups_box; ?>
                                </td>
                                <td valign ="top"><?php echo ' '.JText::_('JLIST_BACKEND_CATSEDIT_CAT_GROUP_ACCESS_DESC'); ?>
                                </td>
                              </tr>                            
...
?>
	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	  ...
	  <tr>
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            <?php // set access info
              ...
              <td colspan="2" align="center">
                  <?php echo JText::_('JLIST_BACKEND_CATSLIST_WRONG_GROUP_ACCESS_SET_TITLE'); ?>
              </td>
			...
			<td align="center"><a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $i;?>','<?php echo $task2;?>')"><img src="images/<?php echo $img;?>" width="16" height="16" border="0" alt="" /></a>
            </td>
        ...
        <tr>
          <td align="center" colspan="14"><?php echo '<img src="images/publish_g.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_PUBLISHED_ICON_DESC').'&nbsp;&nbsp;|&nbsp;&nbsp;'.
                                                      '<img src="images/publish_x.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_UNPUBLISHED_ICON_DESC'); 
                                                     ?>   
          </td>
        </tr>
	</table> 
...
function filesEdit($option, $row, $licenses, $up_files, $inputbox_pic, $listbox_system, $listbox_language, $no_writable, $inputbox_thumb, $inputbox_thumb2, $inputbox_thumb3, $cat_id, $update_files_listbox, $all_custom_arr, $custom_arr, $new_file_from_list) {
	...
	<?php 
        ...
        $yesno = array();
        $yesno[] = JHTML::_('select.option', '0', JText::_('JLIST_FE_NO'));
        $yesno[] = JHTML::_('select.option', '1', JText::_('JLIST_FE_YES'));
        ...
        if ($row->use_timeframe){
            echo '<div align="center"><font color="#990000"><br /><img src="images/publish_y.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_TOOLTIP_INFO').'</font></div>';
        }    
		      			...
		      			<table width="100%">
    	  					<tr>
                                ...
                                <?php echo JText::_('JLIST_BACKEND_FILESEDIT_FILE_TITLE')." "; ?></strong><br />
		    						...
		    						<input name="release" value="<?php echo htmlspecialchars($row->release, ENT_QUOTES ); ?>" size="15" maxlength="255"/>
                                    ...
                                    <strong><?php echo "&nbsp;".JText::_('JLIST_BACKEND_FILE_EDIT_MUST_CONFIRM_LICENSE_TITLE')."&nbsp;"; ?></strong>
                                    <?php echo $confirm ?>
                                </td>
                            </tr>
                            <tr>
					       ...
					       <tr>
							...
							<table>
		  					<tr>
                                ...
                                if ($jlistConfig['files.editor'] == "1") {
                                    echo $editor->display( 'description',  @$row->description , '100%', '350', '75', '20', true, $params ) ;
                                } else {?>
                            ...
                            <tr>
                                ...
                                <?php
                                if ($jlistConfig['files.editor'] == "1") {
                                    echo $editor->display( 'description_long',  @$row->description_long , '100%', '500', '80', '5', true, $params ) ;
                                } else {?>
		      		...
		      		<td valign="top" align="left" width="100%">
		      			<table width="100%">
                           ...
                           <tr>
                                ...
                                <td valign ="top"><?php echo JText::_('JLIST_EDIT_FILE_START_END_DATE_ACTIVATE_DESC').' <font color="#990000">'.JText::_('JLIST_BACKEND_FILESEDIT_TIMEFRAME_INFO2').'</font>'; ?>
                                  </td>
                           </tr> 
                           <tr>
...
echo $pane->startPanel(JText::_('JLIST_BACKEND_SET_TAB_ADD_FIELDS_TITLE'),'customdata');
?>
		    	...
		    	<tr>
		      	...
		      	<tr>
		      		<td valign="top" align="left" width="100%">
		      			<table width="100%">
                            ...
                            <?php } ?>
		  					<tr>
                                ...
                                <td valign ="top"><?php echo " ".JText::_('JLIST_BACKEND_FILESEDIT_FILE_DESC').'<br />'.JText::_('JLIST_BACKEND_FILESEDIT_FILE_DESC2'); ?>
  	    					    </td>
                            </tr>
                             <?php 
                                if($row->file_id){
                            ...
                            <tr>
                                <td><strong><?php echo JText::_('JLIST_BACKEND_FILESEDIT_FILE_UPDATE_FILE_TITLE2')." "; ?></strong><br />
                                <?php echo $update_files_listbox; ?>
                                 <br /></td>
                                <td valign ="top"><?php echo JText::_('JLIST_BACKEND_FILESEDIT_FILE_UPDATE_FILE_DESC2');?>
                                  </td>
                              </tr>
                              <?php } ?>
                            <tr>
                       ...
                       if($row->url_download != ''){ ?>
                            <tr>
                                ...
                                <?php 
                                   echo '<a href="index2.php?option=com_jdownloads&amp;task=download&amp;cid='.$row->file_id.'" target="_blank"><img src="'.JURI::root().'images/jdownloads/downloadimages/download2.png" width="24px" height="24px" border="0" style="vertical-align:middle;" alt="'.JText::_('JLIST_LINKTEXT_DOWNLOAD_URL').'" title="'.JText::_('JLIST_LINKTEXT_DOWNLOAD_URL').'" /></a>&nbsp;';
                    ...
                    <?php } ?>
                          ...
                          <tr><td colspan="3"><hr></td></tr>
                              <tr>
                                   <td><strong><?php echo JText::_('JLIST_BACKEND_FILESEDIT_THUMBNAIL_LIST_TITLE2')." "; ?></strong><br />  
                          ...
                          <tr>
                             <td><strong><?php echo JText::_('JLIST_BACKEND_FILESEDIT_THUMBNAIL_UPLOAD_TITLE')." "; ?></strong><br />
                              ...
                              <td valign ="top"><?php echo " ".JText::_('JLIST_BACKEND_FILESEDIT_THUMBNAIL_UPLOAD_DESC2'); ?>
                              </td>
                          </tr>
	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
	  ...
	  <tr>
		...
		<tr class="<?php echo "row$k"; ?>">
            ...
            $tooltip_timeframe = '';
            if ($row->use_timeframe){
                $date_info = JText::_('JLIST_EDIT_FILE_START_DATE_TITLE').' '.$row->publish_from.'<br />'.JText::_('JLIST_EDIT_FILE_END_DATE_TITLE').' '.$row->publish_to.'<br /><br />'.JText::_('JLIST_BACKEND_FILESLIST_TOOLTIP_INFO');
                $tooltip_timeframe = JHTML::tooltip($date_info, JText::_('JLIST_BACKEND_FILESLIST_TIMEFRAME_INFO'), "../../../administrator/images/publish_y.png");
            } 
			?>
			<td align="center"><a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $i;?>','<?php echo $task2;?>')"><img src="images/<?php echo $img;?>" width="16" height="16" border="0" alt="" /></a><?php if ($tooltip_timeframe) echo $tooltip_timeframe;?></td>
			<td width="25" align="right">
				<?php		if ($i > 0) { ?>
        ...
        <tr>
          <td align="center" colspan="15"><?php echo '<img src="images/publish_g.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_PUBLISHED_ICON_DESC').'&nbsp;&nbsp;|&nbsp;&nbsp;'.
                                                     '<img src="images/publish_y.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_TOOLTIP_INFO').'&nbsp;&nbsp;|&nbsp;&nbsp;'.
                                                     '<img src="images/publish_x.png" width="16" height="16" border="0" alt="" /> '.JText::_('JLIST_BACKEND_FILESLIST_UNPUBLISHED_ICON_DESC'); 
                                                     ?>   
          </td>
        </tr>
...
function filesUpload($option, $task){
  ...
  ?>   
        <form id="form1" action="index.php" method="post" name="adminForm" enctype="multipart/form-data">
        <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
        <tr>
            <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_FILESLIST_TITLE_FILES_UPLOAD');?></th>
        </tr>
        <tr>
            <td style="padding:10px;" colspan="2"> <?php echo JText::_('JLIST_BACKEND_UPLOADER_DESC');?> </td> 
        </tr>
        <tr>
        ...
        <fieldset class="adminform">
         <div id="swfuploader">
          <div class="fieldset flash" id="fsUploadProgress">
               <span class="legend"><?php echo JText::_('JLIST_BACKEND_UPLOADER_QUEUE_TITLE'); ?></span>
          </div>
          <div id="divStatus">0 <?php echo JText::_('JLIST_BACKEND_UPLOADER_FILES_LIST_TITLE'); ?>
          </div>
          <div>
               <span id="spanButtonPlaceHolder"></span>
               <input id="btnCancel" type="button" value="<?php echo JText::_('JLIST_BACKEND_UPLOADER_CANCEL_BUTTON_TITLE'); ?>" onclick="swfu.cancelQueue();" disabled="disabled" style="margin-left: 2px; font-size: 8pt; height: 22px;" />
          </div>
         </div>
        </fieldset>
        </td>
...
?>
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
        <tr cellpadding="10">
        <td colspan="6"><b><?php echo JText::_('JLIST_BACKEND_MANAGE_FILES_DESC'); ?></b>
        </td>
        </tr>
        <tr>
        <td colspan="8" align="right">
        ...
        <tr>
            <th width="5" align="left"><input type="checkbox" name="toggle" value="" onClick="checkAll(<?php echo count( $files_info ); ?>);" /></th>
            <th class="title"><?php echo JText::_('JLIST_BACKEND_MANAGE_FILES_TITLE_NAME')." "; ?></th>
            <th class="title" style="text-align: center"><?php echo JText::_('JLIST_BACKEND_MANAGE_FILES_TITLE_DATE')." "; ?></th>
            <th class="title" style="text-align: center"><?php echo JText::_('JLIST_BACKEND_MANAGE_FILES_TITLE_SIZE')." "; ?></th>
            <th class="title" style="text-align: center"><?php echo JText::_('JLIST_BACKEND_MANAGE_FILES_TITLE_CREATE_NEW_DOWNLOAD')." "; ?></th>
        </tr>
        <?php
        $k=0;
        for($i=0, $n=count($files_info); $i < $n; $i++) {
            $new_download_link = '<a href="index2.php?option=com_jdownloads&amp;task=files.edit&amp;hidemainmenu=1&amp;file='.htmlspecialchars($files_info[$i]['name']).'">'.JText::_('JLIST_BACKEND_MANAGE_FILES_TITLE_CREATE_NEW_DOWNLOAD').'</a>';
            $row = $i;
            ?>
        <tr class="<?php echo "row$k"; ?>">
            <td width="20">
...
<!-- ICON begin -->
    ...
    <table class="adminform">
        ...
        <div style="float:left;">
            <div class="icon">
                <a href="index2.php?option=com_jdownloads&task=manage.files" style="text-decoration:none;" title="<?php echo JText::_('JLIST_BACKEND_FILESLIST_TITLE_MANAGE_FILES');?>">
                <img src="components/com_jdownloads/images/files48.png" width="48px" height="48px" align="middle" border="0"/>
                <br />
                <?php echo JText::_('JLIST_BACKEND_FILESLIST_TITLE_MANAGE_FILES');?>
                </a>
            </div>
        </div>        
        ...
        <div style="float:left;">
            <div class="icon">
                <a href="index2.php?option=com_jdownloads&task=view.groups" style="text-decoration:none;" title="<?php echo JText::_('JLIST_BACKEND_CPANEL_GROUPS');?>">
                <img src="components/com_jdownloads/images/groups.png" width="48px" height="48px" align="middle" border="0"/>
                <br />
                <?php echo JText::_('JLIST_BACKEND_CPANEL_GROUPS');?>
                </a>
            </div>
        </div>        
...
<div style="float:left;">
            <div class="icon">
                <a href="index2.php?option=com_jdownloads&task=view.logs" style="text-decoration:none;" title="<?php echo JText::_('JLIST_BACKEND_CPANEL_DOWNLOAD_LOGS');?>">
                <img src="components/com_jdownloads/images/logs.png" width="48px" height="48px" align="middle" border="0"/>
                <br />
                <?php echo JText::_('JLIST_BACKEND_CPANEL_DOWNLOAD_LOGS');?>
                </a>
            </div>
        </div> 
	...
	<td width="60%" valign="top">
		<div style="width: 100%;"><br />
            ...
            if (!is_dir(JPATH_SITE.'/'.$jlistConfig['files.uploaddir']) &&  $jlistConfig['files.uploaddir'] != ''){ ?>
                <div align="left"><font color="red"><b><?php echo JText::_('JLIST_AUTOCHECK_DIR_NOT_EXIST').'<br /><br />'.JText::_('JLIST_AUTOCHECK_DIR_NOT_EXIST_2').'</b></font></div>'; 
            } 
            if (!is_dir(JPATH_SITE.'/'.$jlistConfig['files.uploaddir'].'/'.JText::_('JLIST_SAMPLE_DATA_CAT_FOLDER_ROOT')) && !$sum){ ?>
                <div align="right"><a href="index2.php?option=com_jdownloads&task=install.sample" title="<?php echo JText::_('JLIST_SAMPLE_DATA_BE_OPTION_LINK_TEXT');?>"><?php echo JText::_('JLIST_SAMPLE_DATA_BE_OPTION_LINK_TEXT').' >> ';?></a></div>
            <?php } ?>
		      		...
		      		<td valign="top" align="left" width="100%">
		      			<table>
                            ...
                            <tr>
                                ...
                                <td><?php echo JText::_('JLIST_BACKEND_LICEDIT_LIC_URL_DESC')." "; ?>
                                </td>                                
		  					</tr>
		  					<tr>
		  						<td colspan="2"><strong><?php echo JText::_('JLIST_BACKEND_LICEDIT_LIC_DESCRIPTION')." "; ?></strong><br />
	  							<?php
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
      <tr>
          <td align="left" colspan ="7">
              <?php
               if (!$jlistConfig['activate.download.log']){
                   echo  JText::_('JLIST_BACKEND_LOG_LIST_SETTINGS_OFF');
               } else {
                   ...
                   if ($reduce_log_data > 0){
                       echo JText::_('JLIST_BACKEND_LOG_LIST_INFO').'<br />'.sprintf(JText::_('JLIST_BACKEND_LOG_LIST_REDUCE_ON'), $reduce_log_data);
                   } else {
                       echo JText::_('JLIST_BACKEND_LOG_LIST_INFO').'<br />'.JText::_('JLIST_BACKEND_LOG_LIST_REDUCE_OFF');
                   }  
               }    ?>
          </td>
          </tr>
          ...
          <td align="right" colspan="7">
            <?php echo JText::_('JLIST_BACKEND_CATSLIST_SEARCH')." "; ?>
                <input type="text" name="search" value="<?php echo $search;?>" class="text_area" onChange="document.adminForm.submit();" />
            <?php echo JText::_('JLIST_BACKEND_CATSLIST_SEARCH_LIMIT')." ";
                  echo $pageNav->getLimitBox();
            ?>
          </td>
      </tr>
        <tr>
            <th width="5" align="left"><input type="checkbox" name="toggle" value="" onClick="checkAll(<?php echo count( $rows ); ?>);" /></th>
            <th class="title"><?php echo JText::_('JLIST_BACKEND_VIEW_LOGS_COL_TITLE_DATE')." "; ?></th>
            <th class="title"><?php echo JText::_('JLIST_BACKEND_VIEW_LOGS_COL_TITLE_USER')." "; ?></th>
            <th class="title"><?php echo JText::_('JLIST_BACKEND_VIEW_LOGS_COL_TITLE_IP')." "; ?></th>
            <th class="title"><?php echo JText::_('JLIST_BACKEND_VIEW_LOGS_COL_TITLE_FILE')." "; ?></th>
        </tr>
        <?php
        $k = 0;
        for($i=0, $n=count( $rows ); $i < $n; $i++) {
        ...
        <tr class="<?php echo "row$k"; ?>">
            ...
            <td><a href="<?php echo $link; ?>" target="_blank" title="<?php echo JText::_('JLIST_BACKEND_VIEW_LOGS_TITLE_CHECK_IP');?>"><?php echo $row->log_ip; ?></a></td>            
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminlist">
      <tr>
          <td colspan="4" align="left">
                <?php
                 echo ' '.JText::_('JLIST_BACKEND_GROUP_LIST_NOTE'); ?>
            </td>
        ...
        <tr>
            ...
            <th valign="top" width="10" align="left" class="title"><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_ID_TITLE')." "; ?></th>
            <th valign="top" class="title"><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_NAME_TITLE')." "; ?></th>
            <th valign="top" class="title"><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_DESC_TITLE')." "; ?></th>
            <th valign="top" align="center" class="title"><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_COUNT_TITLE')." "; ?></th>
            <th valign="top" class="title"><?php echo JText::_('JLIST_BACKEND_GROUPS_EXISTS_USER_TITLE')." "; ?></th>
        </tr>
        <?php
        $k = 0;
        for($i=0, $n=count( $rows ); $i < $n; $i++) {
            $row = &$rows[$i];
            $link = 'index2.php?option=com_jdownloads&task=edit.groups&hidemainmenu=1&cid='.$row->id;
            $checked     = JHTML::_('grid.checkedout', $row, $i );
            ?>
        <tr class="<?php echo "row$k"; ?>">
            <td valign="top"><?php echo $checked; ?></td>
            <td valign="top"><?php echo $row->id; ?></td>
            <td valign="top"><a href="<?php echo $link; ?>" title="<?php echo JText::_('JLIST_BACKEND_GROUPS_EDIT_TITLE');?>"><?php echo $row->groups_name; ?></a></td>
...
//$user = &JFactory::getUser(); 
    ...
    function submitbutton(pressbutton) {
        ...
        if (form.groups_name.value == ""){
            alert( "<?php echo JText::_('JLIST_BACKEND_GROUPS_EDIT_ERROR_TITLE');?>" );
        } else {
    ...
    <table width="100%" border="0">
        <tr>
            ...
            <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                <tr>
                      <th class="adminheading" colspan="2"><?php echo $row->id ? JText::_('JLIST_BACKEND_GROUPS_EDIT_TITLE') : JText::_('JLIST_BACKEND_GROUPS_ADD_TITLE');?></th>
                  </tr>
                  <tr>
                      <td valign="top" align="left" width="100%">
                          <table class="admintable">
                             <tr>
                                <td><strong><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_NAME_TITLE')." "; ?></strong><br />
                                    <input name="groups_name" value="<?php echo htmlspecialchars($row->groups_name, ENT_QUOTES); ?>" size="80" maxlength="150"/>
                                                                 
                            </tr>
                            <tr>
                                <td><strong><?php echo JText::_('JLIST_BACKEND_GROUP_LIST_DESC_TITLE')." "; ?></strong><br />
                ...
                <table class="admintable">
                    <tr>
                        <td colspan="4">
                            <?php echo '<b>'.JText::_('JLIST_BACKEND_GROUPS_EDIT_DESC').'</b>'; ?>
                        </td>
                    </tr>
                    <tr>    
                        <td><?php echo JText::_('JLIST_BACKEND_GROUPS_SELECT_USER_TITLE');?></td>
                        <td width="20%">&nbsp;</td>
                        <td><?php echo JText::_('JLIST_BACKEND_GROUPS_EXISTS_USER_TITLE');?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4"><?php echo JText::_('JLIST_BACKEND_GROUPS_EDIT_SELECT_INFO');?></td>
                    </tr>
                </table>                          
...
echo $pane->startPanel(JText::_('JLIST_BACKEND_TEMPEDIT_CATTITLE'),'catedit');
?>    
	<table width="100%" border="0">
		<tr>
			<td width="100%" valign="top">
...
<?php
echo $pane->endPanel();
echo $pane->startPanel(JText::_('JLIST_BACKEND_TEMPEDIT_TABTEXT_EDIT_HEADER'),'editheader');
?>    
    <table width="100%" border="0">
        <tr>
            <td width="100%" valign="top">
                ...
                <tr>
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                          <table>
                            <!-- HEADER LAYOUT BEGIN -->
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_HEADER_TEXT')." "; ?></strong><br />
                                      <?php
                                    if ($jlistConfig['layouts.editor'] == "1") {
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_HEADER_DESC').'<br />'.JText::_('JLIST_BACKEND_TEMPEDIT_PREVIEW_NOTE');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.$row->template_header_text;
                                   ?>
                                   </td>
                            </tr>
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_TEXT')." "; ?></strong><br />
                                      <?php
                                    if ($jlistConfig['layouts.editor'] == "1") {
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_DESC');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_subheader_text);
                                   ?>
                                   </td>
                            </tr>
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_FOOTER_TEXT')." "; ?></strong><br />
                                      <?php
                                    if ($jlistConfig['layouts.editor'] == "1") {
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_FOOTER_FILES_CATS_DESC');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_footer_text);
                                   ?>
                                   </td>
                            </tr>                            
                            ...
                            <!-- HEADER LAYOUT END -->                            
                            <tr>
                                 <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_HEADER_INFO_TITLE')." "; ?>
                               </th>
                              </tr>
                            <tr>
                               <td>
                              ...
                              <td valign="top"><?php echo JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_HEADER_INFO_DESC');?>
                              </td>
                            </tr>
...
echo $pane->startPanel(JText::_('JLIST_BACKEND_TEMPEDIT_FILESTITLE'),'filesedit');
?>   	
	<table width="100%" border="0">
		<tr>
			<td width="100%" valign="top">
                             ...
                             <tr valign="top">
                                <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_CHECKBOX_TITLE')." "; ?></strong><br />
                                  ...
                                  ?>                    
                                   ...
                                   <td><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_CHECKBOX_DESC').' '.JText::_('JLIST_BACKEND_TEMPEDIT_CHECKBOX_DESC2'); ?>
                                   </td>
                              </tr>                              
		  					...
		  					<tr>
		  						<td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_TEXT')." "; ?></strong><br />
		       					...
		       					<td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_FILES_DESC').'<br /><br />'.JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_FILES_DESC2').'<br /><br />'.JText::_('JLIST_BACKEND_TEMPLATE_EDIT_CUSTOM_FIELD_INFO').'<br /><br />'.JText::_('JLIST_BACKEND_TEMPEDIT_INFO_LIGHTBOX').'<br /><br />'.JText::_('JLIST_BACKEND_TEMPEDIT_INFO_LIGHTBOX2');
                                   ?>
		       					</td>
		  					</tr>
                          ...
                          <table>
                            <!-- HEADER LAYOUT BEGIN -->
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_HEADER_TEXT')." "; ?></strong><br />
                                   ...
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_HEADER_DESC').'<br />'.JText::_('JLIST_BACKEND_TEMPEDIT_PREVIEW_NOTE');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_header_text);
                                   ?>
                                   </td>
                            </tr>
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_TEXT')." "; ?></strong><br />
...
echo $pane->startPanel(JText::_('JLIST_BACKEND_TEMPEDIT_DETAILSTITLE'),'detailsedit');
?>      
    <table width="100%" border="0">
        <tr>
            <td width="100%" valign="top">
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                          <table>
                              ...
                              <tr>
                                  <td valign="top"><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_TEXT')." "; ?></strong><br />
                                      <?php
                                    if ($jlistConfig['layouts.editor'] == "1") {
                                        echo $editor->display( 'template_text',  @$row->template_text , '100%', '500', '80', '5' ) ;
                                        } else {?>
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_DETAILS_DESC').'<br /><br />'.JText::_('JLIST_BACKEND_SETTINGS_TEMPLATES_DETAILS_DESC_FOR_TABS').'<br /><br />'.JText::_('JLIST_BACKEND_TEMPLATE_EDIT_CUSTOM_FIELD_INFO').
                                        '<br /><br />'.JText::_('JLIST_BACKEND_TEMPEDIT_INFO_LIGHTBOX').'<br /><br />'.JText::_('JLIST_BACKEND_TEMPEDIT_INFO_LIGHTBOX2');
                                   ?>
                                   </td>
                              </tr>
                          ...
                          <table>
                            <!-- HEADER LAYOUT BEGIN -->
                                  ...
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_TEXT')." "; ?></strong><br />
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_DETAIL_DESC');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_subheader_text);
                                   ?>
                                   </td>
                            </tr>
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_FOOTER_TEXT')." "; ?></strong><br />
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_FOOTER_OTHER_DESC');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_footer_text);
                                   ?>
                                   </td>
                            </tr>                            
...
echo $pane->startPanel(JText::_('JLIST_BACKEND_TEMPEDIT_SUMTITLE'),'summaryedit');
?>   
                          ...
                          <table>
                            <!-- HEADER LAYOUT BEGIN -->
                                  ...
                                  <td><strong><?php echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_TEXT')." "; ?></strong><br />
                                   ...
                                   <td valign="top">
                                   <?php
                                        echo JText::_('JLIST_BACKEND_TEMPEDIT_SUBHEADER_SUMMARY_DESC');
                                        echo '<br /><br /><font color="#990000">'.JText::_('JLIST_BACKEND_CATSLIST_LINK_TEXT').':</font><br /><br />'.stripslashes($row->template_subheader_text);
                                   ?>
                                   </td>
                            </tr>
		    	...
		    	<tr>
		      	...
		      	<tr>
		      		<td valign="top" align="left" width="100%">
                        ...
                        <td>
                            <br />
                            <?php echo JText::_('JLIST_BACKEND_SETTINGS_DIRECT_DOWNLOAD_ACTIVE_DESC').'<br />'.JText::_('JLIST_BACKEND_SETTINGS_DIRECT_DOWNLOAD_ACTIVE_DESC2');?>
                        </td>
                          </tr>
                        <tr>
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_LOGGING_TITLE')." "; ?></strong><br />
                            <?php echo JHTML::_('select.booleanlist',"jlistConfig[activate.download.log]","",($jlistConfig['activate.download.log']) ? 1:0);?>
                        </td>
                        <td>
                            <br />
                            <?php echo JText::_('JLIST_BACKEND_SET_LOGGING_DESC');?>
                        </td>
                          </tr>                        
		    	...
		    	<tr>
		      	...
		      	<tr>
		      		<td valign="top" align="left" width="100%">
                        ...
                        <td>
                            <br />
                            <?php echo JText::_('JLIST_BACKEND_SETTINGS_VIEW_DETAILSITE_DESC').' <font color="#990000">'.JText::_('JLIST_BACKEND_SETTINGS_VIEW_DETAILSITE_DESC2').'</font>';?>
                        </td>
                        </tr>                         

                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SETTINGS_USE_TITLE_AS_LINK_TITLE')." "; ?></strong><br />
                            <?php echo JHTML::_('select.booleanlist',"jlistConfig[use.download.title.as.download.link]","",($jlistConfig['use.download.title.as.download.link']) ? 1:0);?>
                        </td>
                        <td>
                            <br />
                            <?php echo JText::_('JLIST_BACKEND_SETTINGS_USE_TITLE_AS_LINK_DESC');?>
                        </td>
                        </tr>                         
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_VIEW_FE_ORDERING_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[view.sort.order]","",($jlistConfig['view.sort.order']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_VIEW_FE_ORDERING_DESC');?>
                        </td>                
                        </tr> 
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_REMOVE_TITLE_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[remove.field.title.when.empty]","",($jlistConfig['remove.field.title.when.empty']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_REMOVE_TITLE_DESC');?>
                        </td>                
                        </tr>
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_DEL_EMPTY_TAGS_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[remove.empty.tags]","",($jlistConfig['remove.empty.tags']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_DEL_EMPTY_TAGS_DESC');?>
                        </td>                
                        </tr>                        
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_CONTENT_SUPPORT_FOR_ALL_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[activate.general.plugin.support]","",($jlistConfig['activate.general.plugin.support']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_CONTENT_SUPPORT_FOR_ALL_DESC');?>
                        </td>                
                        </tr>
                        
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_CONTENT_SUPPORT_FOR_DESC_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[use.general.plugin.support.only.for.descriptions]","",($jlistConfig['use.general.plugin.support.only.for.descriptions']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_CONTENT_SUPPORT_FOR_DESC_DESC');?>
                        </td>                
                        </tr>
                        
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_SEF_ROUTER_OPTION_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[use.sef.with.file.titles]","",($jlistConfig['use.sef.with.file.titles']) ? 1:0);?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_SEF_ROUTER_OPTION_DESC');?>
                        </td>                
                        </tr>                        

                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_REDIRECT_FOR_DOWNLOAD_TITLE')." "; ?></strong><br />
                               <input name="jlistConfig[redirect.after.download]" value="<?php echo $jlistConfig['redirect.after.download']; ?>" size="10" maxlength="10"/>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_REDIRECT_FOR_DOWNLOAD_DESC');?>
                        </td>                
                        </tr>
                        <tr><td colspan="2"><hr></td></tr> 
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_USE_TABS_TITLE')." "; ?></strong><br />
                               <?php echo $tabs_box; ?>
                        </td>
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_USE_TABS_DESC');?>
                        </td>                
                        </tr>
                         <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (1)"; ?></strong><br />
                        ...
                        <td>
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_CUSTOM_TAB_TITLES_DESC');?>
                        </td>                
                        </tr>
                         <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (2)"; ?></strong><br />
                        ...
                        <td>
                         ...
                         <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SET_CUSTOM_TAB_TITLES_TITLE')." (3)"; ?></strong><br />
						...
						<tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SETTINGS_FRONTEND_CATS_PER_SIDE')." "; ?></strong><br />
		    					<input name="jlistConfig[categories.per.side]" value="<?php echo $jlistConfig['categories.per.side']; ?>" size="10" maxlength="10"/></td>
    					<td>
    					<br />
    					<?php echo JText::_('JLIST_BACKEND_SETTINGS_FRONTEND_CATS_PER_SIDE_DESC');?>
    					</td>
	  					</tr>
                        <tr>
...
<?php
echo $pane->endPanel();
echo $pane->startPanel(JText::_('JLIST_BE_CONFIG_TAB_TITLE_FE_EDIT'),'frontendedit');
?>
<table width="97%" border="0">
    <tr>
        <td width="40%" valign="top">
                <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BE_CONFIG_HEAD_TITLE_FE_EDIT')." "; ?></th>
                  </tr>
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                        ...
                        <td width="330"><strong><?php echo JText::_('JLIST_BE_CONFIG_EDIT_ACCESS_RIGHTS_USERS')." "; ?></strong><br />
                            <?php echo JHTML::_('select.booleanlist',"jlistConfig[uploader.can.edit.fe]","",($jlistConfig['uploader.can.edit.fe']) ? 1:0);?>
                        </td>
                        </tr>                        

                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BE_CONFIG_EDIT_ACCESS_RIGHTS_TITLE')." "; ?></strong><br />
                           <?php echo $edit_groups_box; ?>
                        </td>
                        <td valign="top">
                        <br />
                               <?php echo JText::_('JLIST_BE_CONFIG_EDIT_ACCESS_RIGHTS_TITLE_DESC');?>
                        </td>                
                        </tr> 
                        </table>
                    </td>
...
<?php
echo $pane->endPanel();
echo $pane->startPanel(JText::_('JLIST_BACKEND_SET_TAB_ADD_FIELDS_TITLE'),'customfields');
?>
<table width="97%" border="0">
    <tr>
        <td width="40%" valign="top">
...
<?php /* custom fields config */ ?>
                <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SET_TAB_ADD_FIELDS_TITLE')." "; ?></th>
                  </tr>
                  <tr>
                    <td valign="top" align="left" width="100%">
                       <table width="100%">
                       <tr>
                        <td colspan="2"><b><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_DESC')." "; ?></b>
                        </td>
                       </tr>

                       <tr>                                                                                     
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TYPE')." ".JText::_('JLIST_BACKEND_SET_ADD_FIELDS_SELECT_FIELD_TYPE'); ?></th>
                      </tr>
                       <tr>
                        <td width="200"><strong><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?></strong><br />
                                1. <input name="jlistConfig[custom.field.1.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.1.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_SELECT_FIELD_VALUE')." "; ?><br />
                       ...
                       <tr>
                        <td width="200">
                                2. <input name="jlistConfig[custom.field.2.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.2.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                3. <input name="jlistConfig[custom.field.3.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.3.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                4. <input name="jlistConfig[custom.field.4.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.4.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                5. <input name="jlistConfig[custom.field.5.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.5.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                        ...
                        <?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_SELECT_FIELD_VALUE_NOTE');?>
                        </font>
                        </td> 
                       </tr>
                       
                       <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TYPE')." ".JText::_('JLIST_BACKEND_SET_ADD_FIELDS_INPUT_FIELD_TYPE'); ?></th>     
                      </tr>                       
                       <tr>
                        <td width="200"><strong><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?></strong><br />
                                6. <input name="jlistConfig[custom.field.6.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.6.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_INPUT_DEFAULT_VALUE')." "; ?><br />
                       ...
                       <tr>
                        <td width="200">
                                7. <input name="jlistConfig[custom.field.7.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.7.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                8. <input name="jlistConfig[custom.field.8.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.8.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                9. <input name="jlistConfig[custom.field.9.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.9.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                       ...
                       <tr>
                        <td width="200">
                                10. <input name="jlistConfig[custom.field.10.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.10.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        <td width="230">
                        ...
                        <tr>
                         <td colspan="2"><font color="#990000">
                        <?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_INPUT_FIELD_VALUE_NOTE');?>
                        </font>
                        </td> 
                       </tr>                                                                                               
                      ...
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TYPE')." ".JText::_('JLIST_BACKEND_SET_ADD_FIELDS_DATE_FIELD_TYPE'); ?></th>     
                      </tr>                       
                       <tr>
                        <td width="200"><strong><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?></strong><br />
                                11. <input name="jlistConfig[custom.field.11.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.11.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        </tr><tr>
                        <td width="200">
                                12. <input name="jlistConfig[custom.field.12.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.12.title'])); ?>" size="50" maxlength="256"/>
                        </td>
                        </tr>
                        
                      <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TYPE')." ".JText::_('JLIST_BACKEND_SET_ADD_FIELDS_TEXT_FIELD_TYPE'); ?></th>     
                      </tr>                       
                       <tr>
                        <td width="200"><strong><?php echo JText::_('JLIST_BACKEND_SET_ADD_FIELDS_FIELD_TITLE')." "; ?></strong><br />
                                13. <input name="jlistConfig[custom.field.13.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.13.title'])); ?>" size="50" maxlength="100"/>
                        </td>
                        </tr><tr>
                        <td width="200">
                                14. <input name="jlistConfig[custom.field.14.title]" value="<?php echo stripslashes(htmlspecialchars($jlistConfig['custom.field.14.title'])); ?>" size="50" maxlength="256"/>
                        </td>
                        </tr>
...
<?php /* Images config */ ?>
		    	...
		    	<tr>
		      	...
		      	<tr>
                      ...
                      <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_SETTINGS_GLOBAL_THUMBNAILS_HEAD')." "; ?></th>
                      </tr>
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_CONFIG_SETTINGS_THUMBS_CREATE_ALL_NEW_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist','resize_thumbs', 'class="inputbox"', 0);?>
                        </td>
                        <td>
                               <?php echo JText::_('JLIST_CONFIG_SETTINGS_THUMBS_CREATE_ALL_NEW_DESC').' '.JText::_('JLIST_CONFIG_SETTINGS_THUMBS_CREATE_ALL_NEW_DESC2');?>
                        </td>
                        </tr>
                        <tr><td colspan="3"><hr></td></tr>
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[create.auto.thumbs.from.pics]","",($jlistConfig['create.auto.thumbs.from.pics']) ? 1:0);?>
                        </td>
                        <td>
                               <?php echo JText::_('JLIST_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_DESC');?>
                        </td>
                        </tr>
                        
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_SCAN_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[create.auto.thumbs.from.pics.by.scan]","",($jlistConfig['create.auto.thumbs.from.pics.by.scan']) ? 1:0);?>
                        </td>
                        <td>
                               <?php echo JText::_('JLIST_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_SCAN_DESC');?>
                        </td>
                        </tr> 
                        ...
                        <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_BIG_IMAGES_HEIGHT');?>
                        </td>
                          </tr>
                          <tr>
                           <td width="330">
                           ...
                           <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_BIG_IMAGES_WIDTH');?>
                           </td>
                        </tr>                        

                        <tr><td colspan="3"><hr></td></tr>
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_CREATE_PDF_THUMB_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[create.pdf.thumbs]","",($jlistConfig['create.pdf.thumbs']) ? 1:0);?>
                        </td>
                        <td>
                               <?php echo JText::_('JLIST_BACKEND_CREATE_PDF_THUMB_DESC');?>
                        </td>
                        </tr>
                        <tr><td width="330">      
                               <?php if (extension_loaded('imagick')){
                                        echo '<font color="green">'.JText::_('JLIST_BACKEND_IMAGICK_STATE_ON').'</font>';
                                  } else {
                                        echo '<font color="red">'.JText::_('JLIST_BACKEND_IMAGICK_STATE_OFF').'</font>';
                                  } ?> 
                        </td>
                        </tr>
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_CREATE_AUTO_THUMBS_BY_PICS_SCAN_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[create.pdf.thumbs.by.scan]","",($jlistConfig['create.pdf.thumbs.by.scan']) ? 1:0);?>
                        </td>
                        <td>
                               <?php echo JText::_('JLIST_BACKEND_CREATE_PDF_THUMB_SCAN_DESC');?>
                        </td>
                        </tr>
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_THUMBS_IMAGE_TYPE_TITLE')." "; ?></strong><br />
                              <?php echo $file_type_inputbox; ?>
                        <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_THUMBS_IMAGE_TYPE'); ?>
                        </td>
                        </tr>
                        <tr>
                        <td width="330">
                        ...
                        <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_THUMBS_HEIGHT');?>
                        </td>
                        </tr>
                        <tr>
                           <td width="330">
                           ...
                           <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_THUMBS_WIDTH');?>
                           </td>
                        </tr>
                        <tr>
                        <td width="330">
                        ...
                        <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_BIG_THUMBS_HEIGHT');?>
                        </td>
                          </tr>
                          <tr>
                           <td width="330">
                           ...
                           <td>
                            <?php echo JText::_('JLIST_CONFIG_SETTINGS_PDF_BIG_THUMBS_WIDTH');?>
                           </td>
                        </tr> 
                        
                        <tr><td colspan="3"><hr></td></tr>       
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_SETTINGS_VIEW_PLACEHOLDER_TITLE')." "; ?></strong><br />
                               <?php echo JHTML::_('select.booleanlist',"jlistConfig[thumbnail.view.placeholder]","",($jlistConfig['thumbnail.view.placeholder']) ? 1:0);?>
                               <br />
                               <?php 
                               $nopic = '<img src="'.$mainframe->getSiteURL().'images/jdownloads/screenshots/thumbnails/no_pic.gif" width="'.$jlistConfig['thumbnail.size.width'].'" height="'.$jlistConfig['thumbnail.size.height'].'" />';
                               echo $nopic;
                               ?> 
                        </td>
                        <td valign="top">
                ...
                <tr>
                  ...
                  <tr>
                      <td valign="top" align="left" width="100%">
                        ...
                        <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_CATSEDIT_CAT_GROUP_ACCESS_TITLE')." "; ?></strong><br />
                           <?php echo $groups_box; ?>
                        </td>
                        <td valign="top">
                        <br />
                               <?php echo JText::_('JLIST_BACKEND_SET_CAT_GROUP_UPLOAD_ACCESS_DESC');?>
                        </td>                
                        </tr> 
...
<?php /* Backend config */ ?>
                ...
                <tr>
                  ...
                  <tr>
                     <td width="330" valign="top"><strong><?php echo JText::_('JLIST_STOP_LEECHING_ALLOWED_SITES_OPTION_TITLE')." "; ?></strong><br />
                ...
                <tr>
                    <td width="330">
                        <strong><?php echo JText::_('JLIST_BACKEND_USE_BLACKLIST_TITLE')." "; ?></strong><br />
                         <?php echo JHTML::_('select.booleanlist',"jlistConfig[use.blocking.list]","",($jlistConfig['use.blocking.list']) ? 1:0);?>
                    </td>
                    <td>
                        <?php echo JText::_('JLIST_BACKEND_USE_BLACKLIST_DESC');?>
                    </td>
                  </tr>
                  <tr>
                     <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_BLACKLIST_TITLE')." "; ?></strong><br />
                             <textarea name="jlistConfig[blocking.list]" rows="15" cols="40"><?php echo $jlistConfig['blocking.list']; ?></textarea>
                     </td>
                     <td valign="top">
                              <?php echo JText::_('JLIST_BACKEND_BLACKLIST_DESC');?>
                     </td>
                   </tr>                
                   </table>
                   </td>
...
<?php if ($jlistConfig['pad.exists']){ ?>
   ...
   <?php } ?>
                 ...
                 <table cellpadding="4" cellspacing="1" border="0" class="adminlist">
                <tr>
                      <th class="adminheading" colspan="2"><?php echo JText::_('JLIST_BACKEND_POST_COM_ID_TITLE')." "; ?></th>
                  </tr>
                  ...
                  <tr>
                     ...
                     if ($jlistConfig['com'] == ''){ ?>   
                       ...
                       <tr>
                        <td width="330"><strong><?php echo JText::_('JLIST_BACKEND_POST_COM_ID_TITLE2')." "; ?></strong><br />
                               <input name="com" value="" size="50" maxlength="50"/>
                        </td>
                        <td>
                            <br />
                            <?php echo JText::_('JLIST_BACKEND_POST_COM_ID_DESC');?>
                        </td>
                        </tr>              
                     <?php } else { ?>
                       <tr>
                        <td>
                            <?php echo JText::_('JLIST_BACKEND_POST_COM_ID_ACTIVE');?>
                        </td>
                        </tr>              
                     <?php } ?>
